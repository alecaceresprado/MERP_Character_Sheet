import { classes, objectTypes, races } from '../constants';

export const LotharPicco = {
  details: {
    name: 'Lothar Picco',
    nickName: 'Loti Picco',
    race: races.NORSEMEN,
  ...
  inventory: [
    {
      ...
      type: objectTypes.SKILL_ENHANCER,
    ...
    },
    {
      ...
      quantity: 1,
      type: objectTypes.WEAPON,
      skill: [['weapons', 'dualWeapons'], ['weapons', 'projectile']],
      modifier: 10,
      description:
